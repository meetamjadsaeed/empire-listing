...
function empirelisting_scripts() {
	wp_enqueue_style( 'empirelisting-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'empirelisting-style', 'rtl', 'replace' );

	wp_enqueue_script( 'empirelisting-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
